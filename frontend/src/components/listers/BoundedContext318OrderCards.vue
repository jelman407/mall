    ...
    <div>
        ...
        <v-col style="margin-bottom:40px;">
            <div class="text-center">
                ...
                >
                    <BoundedContext318Order :offline="offline" class="video-card" :isNew="true" :editMode="true" v-model="newValue" 
        ...
        <v-row>
            <BoundedContext318Order :offline="offline" class="video-card" v-for="(value, index) in values" v-model="values[index]" v-bind:key="index" @delete="remove"/>
        </v-row>
    </div>
</template>
...
<script>
    ...
    import BoundedContext318Order from './../BoundedContext318Order.vue';

    export default {
        name: 'BoundedContext318OrderManager',
        components: {
            BoundedContext318Order,
        },
        props: {
            offline: Boolean
        },
